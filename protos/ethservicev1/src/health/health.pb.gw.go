...
/*
Package ethservicev1health is a reverse proxy.
...
var (
	pattern_Health_Status_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "health"}, "", runtime.AssumeColonVerbOpt(true)))
)
